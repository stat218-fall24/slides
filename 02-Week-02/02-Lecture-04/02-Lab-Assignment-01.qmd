...
**Question 0: Please add a code chunk below and add necessary `install.packages()` and `library()` functions (look at my slides). If you skip this part, your functions will not work.**
...
**Question 3: What types of variables are there in this data set? Identify each variable below (nominal, ordinal, discrete, and continuous?)**
...
This version adds slight tweaks to enhance readability.
