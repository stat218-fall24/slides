...
- identified the differences between anecdotal evidence and empirical evidence    
- discussed the differences between observational study, and experimental study 
...
- have an introduction to descriptive statistics  
  - see some examples of frequency distributions enabling us to summarize __categorical variable__ and/or __quantitative variable__ 
    - either as a table or a graph

- see how to identify shape, center, and (maybe tomorrow) dispersion in a data set.
...
Data sets can be messy and overwhelming at first glance. By using statistics, we can:
...
- They can tell a story or can be useful for exploring data
...
::: fragment
__Inferential Statistics:__ Statistics used for making predictions and draw conclusions. _(We will come to that point on Wednesday)_
:::
