...
subtitle: "Week 9, Lecture 3 Lab 7"
date: today
...
__Step 2: Generate Your Model__

__IMPORTANT:__ The codes I use include the `babies` dataset. If you chose a different dataset, such as `babies1` or `babies2`(see your environment pane), be sure to replace `babies` with the correct dataset name in all instances.
